...
const Index = () => {
  ...
  // New useEffect to add portfolio card when component mounts (dashboard loads)
  useEffect(() => {
    // Add portfolio card when dashboard page loads
    addPortfolioCard();
  }, []); // Empty dependency array means this runs once on mount
  
  function addPortfolioCard() {
    // Add a portfolio card when the dashboard loads
